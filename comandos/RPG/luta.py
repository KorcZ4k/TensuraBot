...
class _UIContext:
    """Adapta Context e Interaction para usar a mesma mensagem do combate."""
    ...
    @property
    def channel(self):
        return self._message.channel if self._message is not None else getattr(self._original, "channel", None)

    @property
    def guild(self):
        return getattr(self._message, "guild", getattr(self._original, "guild", None))
